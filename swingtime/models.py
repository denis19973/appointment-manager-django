...
class Event(models.Model):
    ...
    email = models.EmailField(_('email'), max_length=100, unique=True, blank=False)
    ...
    def get_start_time(self):
        return Occurrence.objects.get(event_id=self.pk).start_time
...
class Occurrence(models.Model):
    ...
    # ---------------------------------------------------------------------------
    def __str__(self):
        return u'{}: {}'.format(self.email, self.start_time.isoformat())
